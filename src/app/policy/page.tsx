...
const Policy = () => {
    return (
        <main className="main">
            <section>
                <Container>
                    <h1 style={{margin: "100px 0"}}>ПОЛИТИКА КОНФИДЕНЦИАЛЬНОСТИ</h1>
                    <h2 style={{textAlign: "center", marginBottom: 40}}>Политика в отношении обработки персональных данных</h2>
                    ...
                    <div style={{marginBottom: 100}}>
                        ...
                        3.4. Сведения об имущественном положении;
                        3.5. Сведения о задолженности;
                        3.6. Также на сайте происходит сбор и обработка обезличенных данных о посетителях (в т.ч. файлов
                        «cookie») с помощью сервисов интернет-статистики (Яндекс Метрика и Гугл Аналитика и других).
                        3.7. Вышеперечисленные данные далее по тексту Политики объединены общим понятием Персональные
                        данные.
                        ...
                        посредством
                        электронной почты на электронный адрес Оператора  с пометкой «Отзыв согласия
                        на
                        ...
                        обработки
                        его персональных данных, обратившись к Оператору с помощью любых каналов связи.
